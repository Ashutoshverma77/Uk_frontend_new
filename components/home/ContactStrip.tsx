  ...
  const handleCopyAddress = async () => {
    try {
      if (navigator?.clipboard?.writeText) {
        await navigator.clipboard.writeText(PHARMACY_ADDRESS);
        ...
        <div className="grid items-stretch gap-5 md:grid-cols-2">
          ...
          <div className="flex h-full flex-col justify-between rounded-3xl border border-slate-200 bg-white p-5 text-xs text-slate-700 shadow-soft-card md:p-6 md:text-sm">
            <div>
              ...
              <p className="mt-1">{PHARMACY_ADDRESS}</p>

              <div className="mt-4 flex flex-wrap gap-2 text-xs md:text-[13px]">
                {/* Open directions */}
                <a
                  href="https://www.google.com/maps/place/53%C2%B041'57.4%22N+1%C2%B030'37.9%22W"
                  target="_blank"
                  rel="noreferrer"
            ...
            <p className="mt-4 text-[11px] text-slate-500">
              Free parking available on-site. Please check opening times before
              you travel.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-2 shadow-soft-card">
            <div className="relative h-56 w-full overflow-hidden rounded-2xl md:h-64 lg:h-72">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m13!1m8!1m3!1d6108.179704923851!2d-1.511364!3d53.6991!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNTPCsDQxJzU3LjQiTiAxwrAzMCczNy45Ilc!5e1!3m2!1sen!2sus!4v1764139161990!5m2!1sen!2sus"
                loading="lazy"
